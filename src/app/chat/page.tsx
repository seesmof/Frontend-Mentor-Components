  ...
  return (
    <>
      <div className="relative z-10 w-full min-h-screen overflow-hidden bg-gray-100">
        <div className="rounded-br-full rounded-bl-full bg-linear-to-tr to-[#e942ef] from-[#8838ff] w-screen h-[50vh] top-0 -left-1/2 md:-left-2/3 absolute -z-10"></div>
        <div className="rounded-tr-full rounded-tl-full bg-[#c6c2c6] bg-opacity-10 w-screen h-[50vh] bottom-0 -right-1/2 md:-right-2/3 absolute -z-10"></div>
        ...
        <main className="md:flex-row md:px-8 z-10 flex flex-col items-center justify-center max-w-5xl min-h-screen gap-8 mx-auto">
          <div className="md:w-1/2">
            <div className="bg-neutral-50 w-[18rem] shadow-2xl p-3 h-155 rounded-3xl">
              <div className="rounded-2xl relative w-full h-full overflow-hidden bg-gray-100">
                ...
                <header className="bg-linear-to-r to-[#e942ef] text-neutral-50 from-[#8838ff] pt-9 p-3 rounded-br-lg rounded-bl-lg shadow-sm">
                ...
                <main className="flex text-[.7rem] flex-col h-full p-2 gap-y-2">
                  ...
                  <div className="bg-linear-to-r px-2 py-3 from-[#e942ef] to-[#8838ff] w-3/4 rounded-xl rounded-bl-sm text-neutral-50 flex flex-row justify-between items-center">
