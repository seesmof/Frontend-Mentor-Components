        ...
        <div className="min-h-screen bg-[#36384d] font-medium w-full flex items-center justify-center">
          <div className="bg-white lg:rounded-xl h-screen lg:h-min lg:w-max lg:p-6 w-full">
            <div className="flex flex-col lg:flex-row-reverse lg:gap-6 h-full">
              <img
                src="/newsletter-sign-up-with-success-message-component/illustration-sign-up-mobile.svg"
                alt=""
                className="block lg:hidden object-cover object-bottom md:h-[46vh] w-full"
              />
              <img
                src="/newsletter-sign-up-with-success-message-component/illustration-sign-up-desktop.svg"
                alt=""
              ...
              <div className="flex flex-col lg:justify-center">
                ...
                >
                  ...
                  <input
                    ...
                    ref={email}
                  />
                  <button className="w-full bg-slate-800 text-white p-4 rounded-xl hover:bg-gradient-to-r hover:from-pink-500 hover:to-orange-500 hover:shadow-lg hover:shadow-orange-400/50 active:scale-95 mt-6">
